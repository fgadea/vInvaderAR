...
public class GyroController : MonoBehaviour 
{
	...
	{	
		if(/*VRSettings.isDeviceActive*/SystemInfo.supportsGyroscope){
	...
	{	
		...
		if (noGyro)
			transform.eulerAngles += new Vector3(-CrossPlatformInputManager.GetAxis("Vertical"),CrossPlatformInputManager.GetAxis("Horizontal"), 0);
		else
		{
